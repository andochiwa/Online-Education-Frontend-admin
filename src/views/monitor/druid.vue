<template>
  <div>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-button style="width: 300px" type="primary">
          <a href="http://andochiwa.top:8003/druid" target="_blank">
            service_vod
          </a>
        </el-button>
      </el-col>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-button style="width: 300px" type="primary">
          <a href="http://andochiwa.top:8006/druid" target="_blank">
            service_order
          </a>
        </el-button>
      </el-col>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-button style="width: 300px" type="primary">
          <a href="http://andochiwa.top:8008/druid" target="_blank">
            service_acl
          </a>
        </el-button>
      </el-col>
